...
namespace asgn5v1
{
    ...
    public class Transformer : System.Windows.Forms.Form
    {
        ...
        bool GetNewData()
        {
            ...
            initObject(ref ctrans); // Initialize the object
            return true;
        } // end of GetNewData
        ...
        /*
         * From directions:
         *  Initially displays your block character on screen/window, "top-upwards" with center at the center of the screen,
         *  and vertical height equal to half the vertical height of the screen/window.
         */
